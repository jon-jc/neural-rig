...
void NeuralRig::_UnserializeApplyConfig(nlohmann::json& config)
{
...
int NeuralRig::_UnserializeStateWithKnownVersion(const iplug::IByteChunk& chunk, int startPos)
{
...
int NeuralRig::_UnserializeStateWithUnknownVersion(const iplug::IByteChunk& chunk, int startPos)
{
  nlohmann::json config;
